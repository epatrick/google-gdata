...
namespace Google.GData.Client
{
    ...
    public class GDataGAuthRequest : GDataRequest
    {
       ...
       sprivate VersionInformation responseVersion;
...
/// <summary>does the real disposition</summary> 
        ...
        protected void Execute(int retryCounter)
        {
            ...
            catch (GDataRequestExcept re)
            {
                ...
                iretryCountering > this.factory.NumberOfRetries)
                {
        ...
        EnsureWebRequest();
                this    base.Request.ContentLength = this.requestCopy.Length;
